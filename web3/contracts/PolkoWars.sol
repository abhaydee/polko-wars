...
contract PolkoWars is ERC1155, Ownable, ERC1155Supply {
    IBatch private immutable batch;
    ...
    // Function to perform a batch transfer using Moonbeam's batch precompile
    function batchTransfer(
        ...
        // Create the BatchOps array to store the batch operations
        IBatch.BatchOp[] memory ops = new IBatch.BatchOp[](_recipients.length);

        // Populate the BatchOps array with the transfer operations
        // for (uint256 i = 0; i < _recipients.length; i++) {
        //     ops[i].op = IBatch.BatchOp.Transfer(
        //         _recipients[i],
        //         address(this), // Use the PolkoWars contract as the sender
        //         _tokenIds[i],
        //         _amounts[i]
        //     );
        // }
